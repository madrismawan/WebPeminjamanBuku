            ...
            <div class="card card-outline">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>Tanggal Kembali Buku <span class="text-danger">*</span></label>
                                <input name="tanggal" value="{{date('d-m-Y'), strtotime($data->updated_at)}}" type="text" class="form-control" id="exampleInputEmail1"  disabled>
                            </div>
                        </div>
                    </div>
                </div>
