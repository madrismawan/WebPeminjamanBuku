                ...
                <div class="col-12 col-sm-6 p-0">
                    <div class="card card-primary mb-0">
                        <div class="card-header bg-white text-center">
                            <img class="rounded mx-auto d-block my-3" src="{{ asset('base-template/dist/img/logo.png') }}" alt="peminjaman buku logo" width="80" height="80">
                            <p class="login-box-msg mb-0 pb-0 px-0 fw-bold h6 mt-2 mb-1"> Selamat Datang di Sistem</p>
                            <a href="" class="text-decoration-none h4 fw-bold m-2">Peminjaman Buku</a>
                        </div>
                        <div class="card-body">
